 ...
 ******************
 1 first order node
 1 root  node  -->  Total number of elements, recursive counting of all {} sets contained in fundamental number 0
...
Meaning = Air, Manifest in 3D Solid, Tetrahedron, Energy, Spirit, Aerobic Life ==> Spatial Field
The Octahedron
...
*  FOUR
 ...
 Meaning = Consciousness, Magic of Form,  (Foundation)  ==> Spirit and Matter United
 The Dodecahedron


 4 =            [ {+(0,  4   ) *2} ,  {  *(1,    4)    *2}  ,   { +(2,   2)    *2} ,     {+(  1  , 3)  *2}   ,   {+( 1 , 1 ,  2) *3}   ,  {+(1 ,1 ,1 ,1}  ]   -->  6 first order elements
 #expansion#         /  ///||| *2 &;      /|  ///|||  *2    &;     /||   /||  *2  &;         /|   //||  *2  &;     /|  /|  //|  *3    &;  /| /| /| /|  &;
 #expansion#            14         +        16              +       12             +          12             +           21           +          8           ==>  83 root elements

 ******************
 6  first order nodes
 83 root nodes   -->  Total number of elements, recursive counting of all {} sets contained in fundamental number 4

 F_Conj_additive_single_decimal_compression_map(4) = 2
...
The Icosahedron   -->  The last perfect geometric solid
 ...
 5 =                [ {+(0,   5)   *2} ,      {+(1,   4)   *2}   ,  {+(2,    3) *2 }   , {*(1,    5)   *2}   ,  {+(1,  2,   2)  *3}  ,  {+(1,  3,    1) *3}  ,  {+(1,  1,  1,  2) *4}  , {+(1,  1,  1,  1,  1)} ]  ---> 8 first order elements
 #expansion#           /  ////\\\\ *2 &:        /| ///|||  *2   &;   //|   //|| *2    &;   /| ////|||| *2   &;    /|  //| //|   *#  &;   /|  //||   /|  *3) &;    /|  /|  /| //|  *4  &;   /|  /|  /|  /|  /|
 #expansion count#         16         +            16            +       14            +        20           +       24              +        24             +          27             +         10       ===========>  143   root elements

 ******************
 8  first order nodes
 143  root nodes -->  Total number of elements, recursive counting of all {} sets contained in fundamental number 5

 F_Conj_additive_single_decimal_compression_map(5) = 8


 -------------------------------------------------------------------------------------------
 *  SIX
 *  Meaning =  Double spirit, star of david, 1 number past the brockenly semetric number, perfection in spirit, 3 on 3.

 6 =              [ {+(0,   6)     *2}      ,  {+(1,     5)   *2}  ,  {+(2,   4  )  *2}    ,  {+(3,   3)}   ,  {*(1,      6)    *2}    , {*(2,    3) *2}  ,  {+(1,  1,  4 ) *3}    , {+(1,  2,   3  )   *6}  ,  {+( 1, 1,   2,   2) *6 } , {+(1,  1,   1,  1,   2)  *5} , {+(1,  1,  1,  1,  1,  1)}  ] ---> 11 first order elements
 #expansion#         /  //////|||||    *2 &;   /|  ////||||  *2  &;   //\  ///|||      &;  //||  //|| &;     /|  //////||||| *2  &;  //\  //|| *2  &;   /|  /|  ///|||   &;  /|  //|  //||    *6  &;    /|  /|  //|  //|  *6  &;  /|   /|  /|   /|  //|  *5 ;&       /|  /|  /|  /|  /|  /|
 #expansion count#      12         *2      +        10       *2   +      9        *2   +       8      +           13         *2  +      7      *2   +          10          +       9        *6     +           10         *6   +            11           *5  +             12
                             24            +            20       +        18           +       8      +             26           +         14       +          30          +            54         +               60          +                   55        +             12    ===>  301 root elements
 ******************
 11 first order nodes
 301 root nodes  -->  Total number of elements, recursive counting of all {} sets contained in fundamental number 6

 F_Conj_additive_single_decimal_compression_map(6) = 4
...
/*    Make a recursion function to calaculate out need first order elements.
      ...
      So -- Let's try splitting up the work...........   :)   :)    :)
 *
 *
 *
 * */
